...
~/.cargo/bin/cargo run -p axl-compiler -- blocks examples/next/crm.axl
...
formatted Packed Graph IR, a machine-readable open-block manifest and initial
Rust, React, SQL and agent target contracts.
