...
## 8. Foundation catalog for software agents
...
presented as current AXL syntax. Blueprint instances and package overlays are
also not implemented: customization currently happens in the AXL blueprint
source by changing parameters or selecting compatible providers. See
